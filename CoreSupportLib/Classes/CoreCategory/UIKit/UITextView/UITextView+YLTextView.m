...
- (void)layoutSubviews {
    ...
    if (self.limitLength && self.wordCountLabel) {
         ...
         *  2018-8-15
         */
        CGFloat wordCountLabelW=CGRectGetWidth(self.frame)-10;
        CGFloat wordCountLabelH=20;
        CGFloat wordCountLabelX=0;
        CGFloat wordCountLabelY=CGRectGetHeight(self.frame)-20+self.contentOffset.y;
        self.wordCountLabel.frame=CGRectMake(wordCountLabelX,wordCountLabelY,wordCountLabelW,wordCountLabelH);
    }
