...
- (void)setNavigationAlpha:(NSString *)navigationAlpha{
    /*
    ...
    objc_setAssociatedObject(self, CloudoxKey, navigationAlpha, OBJC_ASSOCIATION_COPY_NONATOMIC);
    
    // 设置导航栏透明度（利用Category自己添加的方法）
    [self.navigationController setNeedsNavigationBackground:[navigationAlpha floatValue]];
}

- (NSString*)navigationAlpha{
